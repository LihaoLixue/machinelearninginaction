...
from 猫狗识别 import input_data
from 猫狗识别 import model
...
CAPACITY = 256
MAX_STEP = 150  # 训练的步数，应当 >= 10000
learning_rate = 0.0001  # 学习率，建议刚开始的 learning_rate <= 0.0001


def run_training():
    # 数据集
    train_dir = 'catAndgod/image/'  # My dir--20170727-csq
    # logs_train_dir 存放训练模型的过程的数据，在tensorboard 中查看
    logs_train_dir = 'catAndgod/saveNet/'
