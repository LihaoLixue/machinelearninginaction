...
def getData(keep_binary=False, keep_bins=False, keep_scaled=False, keep_interactive_auto=False,
            keep_interactive_manually=False):
    """
    Parameters:
    ...
    if keep_interactive_auto:
        numerics = df[['Names_scaled', 'SibSp_scaled', 'Parch_scaled', 'TicketPrefix_id_scaled', 'Fare_scaled',
                       'CabinNumber_scaled',
                       'Pclass_scaled', 'Title_id_scaled', 'TicketNumber_scaled', 'CabinLetter_scaled',
                       'Embarked_scaled', 'Age_scaled']]
